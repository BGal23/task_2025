The application is a simple online store using a free API. It is used to browse store products, sort and check details. I used TypeScript, React, React-DOM, MaterialUI and other libraries to create it.
